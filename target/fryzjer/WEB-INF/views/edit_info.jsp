...
<form action="${pageContext.request.contextPath }/edit_info" method="post">
    <div class="container">


        <div class="card  text-center bg-dark">
            <div class="card-header">
                Zmień informacje na temat ${customer.firstName} ${customer.lastName}
            </div>
            ...
            <div class="card-body">
                <div class="input-group form-group">
                    ...
                    <div class="input-group form-group">
                        ...
                        <input type="text" name="info" class="form-control" value="${customer.info}">
                    </div>
